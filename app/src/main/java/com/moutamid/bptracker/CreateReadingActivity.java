...
public class CreateReadingActivity extends AppCompatActivity {
    ...
    private static class ReadingModel {
        ...
        public ReadingModel(String date, String cuffLocation, String bodyPosition, String systolic, String diastolic, String pulse, String weight, String spo2, String glucose, String status, String pp, String pushKey, String userUid, String map) {
            this.date = date;
